...
int  main()
{
	mov_reader_test("d:\\video\\mp4\\H265-G711U-56434.mp4");

	//mov_reader_test("F:\\video\\mp4\\H264_AAC_2021-02-10_1080P.mp4"); //OK 
	//mov_reader_test("F:\\video\\27601227\\15080035.MOV");
