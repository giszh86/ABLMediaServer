...
static int hls_init_segment(hls_fmp4_t* hls, hls_m3u8_t* m3u)
{
	...
	FILE* fp = fopen("D:\\WorkDir\\2021\\ABLMediaServer\\ABLMediaServer\\media-server-master\\Example\\hls-segmenter-mp4\\hls\\0.mp4", "wb");
...
static int hls_segment(void* m3u8, const void* data, size_t bytes, int64_t /*pts*/, int64_t dts, int64_t duration)
{
	...
	snprintf(name, sizeof(name), "D:\\WorkDir\\2021\\ABLMediaServer\\ABLMediaServer\\media-server-master\\Example\\hls-segmenter-mp4\\hls\\%d.mp4", ++i);
...
void hls_segmenter_fmp4_test(const char* file)
{
	...
	FILE* fp = fopen("D:\\WorkDir\\2021\\ABLMediaServer\\ABLMediaServer\\media-server-master\\Example\\hls-segmenter-mp4\\playlist.m3u8", "wb");
...
{
	printf("hello world \r\n");
	hls_segmenter_fmp4_test("d:\\video\\mp4\\H265_AAC_2021-07-07.mp4");
	while (true)
		Sleep(200);
}
