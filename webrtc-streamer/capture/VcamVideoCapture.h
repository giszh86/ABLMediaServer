...
//摄像头数据获取
class VcamVideoCapture :public VideoCapture, public rtc::VideoSinkInterface<webrtc::VideoFrame>
{
public:
	VcamVideoCapture();
	~VcamVideoCapture();
	...
	virtual bool onData(const char* id, unsigned char* buffer, int size, int64_t ts) { return true; };
