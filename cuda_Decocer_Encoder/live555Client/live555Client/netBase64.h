...
int Base64Encode(unsigned char * b64, const unsigned char * input, uint32_t stringlen = 0);
int Base64Decode(unsigned char * output, const unsigned char * b64, uint32_t codelen = 0);
