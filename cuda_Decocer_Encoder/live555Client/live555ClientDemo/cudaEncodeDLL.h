...
无
*/
extern "C" __attribute__((visibility("default")))  bool cudaEncode_Init();
...
N   有N个英伟达显卡
*/
extern "C" __attribute__((visibility("default")))  int  cudaEncode_GetDeviceGetCount();
...
false           获取失败
*/
extern "C" __attribute__((visibility("default")))  bool  cudaEncode_GetDeviceName(int nOrder, char* szName);
...
*/
extern "C" __attribute__((visibility("default")))   bool cudaEncode_CreateVideoEncode(cudaEncodeVideo_enum videoCodec, cudaEncodeVideo_enum yuvType, int nWidth, int nHeight, uint64_t& nCudaChan);

//删除解码句柄
extern "C" __attribute__((visibility("default")))   bool cudaEncode_DeleteVideoEncode(uint64_t nCudaChan);

extern "C" __attribute__((visibility("default")))  int  cudaEncode_CudaVideoEncode(uint64_t nCudaChan, unsigned char* pYUVData, int nYUVLength, char* pOutEncodeData);

extern "C" __attribute__((visibility("default")))   bool cudaEncode_UnInit();
