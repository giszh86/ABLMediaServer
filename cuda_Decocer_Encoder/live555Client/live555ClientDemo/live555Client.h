...
/*参数说明
uint64_t        nRtspChan       rtsp通道号，0 ~ 255
...
*/
typedef void(*LIVE555RTSP_AudioVideo)  (uint64_t nRtspChan, int RtspDataType, char* codeName, unsigned char * pAVData, int nAVDataLength, int64_t timeValue, void* pCustomerData);
...
int& nOutChan        输出通道号，相当于连接句柄
*/
extern "C"   __attribute__((visibility("default")))  bool live555Client_ConnectCallBack(char* szURL, XHRtspURLType nXHRtspURLType, bool bTCPFlag, void* pCustomerPtr, LIVE555RTSP_AudioVideo callbackFunc, uint64_t& nOutChan);
...
*/
extern "C"   __attribute__((visibility("default")))  bool live555Client_Speed(uint64_t nChan, float fSpeed);
...
*/
extern "C"   __attribute__((visibility("default")))  bool live555Client_Seek(uint64_t nChan, int64_t timeStamp);
...
int     nChan        通道号
*/
extern "C"   __attribute__((visibility("default")))  bool live555Client_Pause(uint64_t nChan);
...
int     nChan        通道号
*/
extern "C"   __attribute__((visibility("default")))  bool live555Client_Resume(uint64_t nChan);
...
*/
extern "C"   __attribute__((visibility("default")))  bool live555Client_GetNetStreamStatus(uint64_t nChan);
...
int   nChan        通道号
*/
extern "C"   __attribute__((visibility("default")))  bool live555Client_Disconnect(uint64_t nChan);
